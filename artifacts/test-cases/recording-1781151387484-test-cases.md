...
**Generated from**: recording-1781151387484-final.json
**Date**: June 11, 2026
...
### Test Steps
1. Click on div.boHomeCatalog > div.boSquare.boSquareTenant > div.boSquareContent > div.boSquareTable > div.boSquareCell > span.icon-maker.icon-maker-services (div.boHomeCatalog > div.boSquare.boSquareTenant > div.boSquareContent > div.boSquareTable > div.boSquareCell > span.icon-maker.icon-maker-services)
2. Click on CUSTOMERS (#nav-link-customer)
3. Click on ACCOUNTS (#nav-link-account)
4. Click on USERS (#nav-link-user)
