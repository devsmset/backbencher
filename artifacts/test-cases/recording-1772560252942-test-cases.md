...
**Generated from**: recording-1772560252942-final.json
**Date**: March 3, 2026
...
2. Click on 433469027 (div.fixedDataTableRowLayout_body > div.fixedDataTableCellGroupLayout_cellGroupWrapper > div.fixedDataTableCellGroupLayout_cellGroup > div.fixedDataTableCellLayout_main.public_fixedDataTableCell_main > div.entityGridCell > a)
...
5. Click on AUDIT (#nav-link-audit)
...
### Test Steps
1. Click on smax-filter-panel.filter-container.smax-filter-panel > a.smax-filter-panel-clear > span.icon-delete.platform-filter-panel-clear-icon (smax-filter-panel.filter-container.smax-filter-panel > a.smax-filter-panel-clear > span.icon-delete.platform-filter-panel-clear-icon)
2. Click on Tenant (div.audit-header-fixed > div.audit-header-flex-box > div.audit-header-submenu > div.audit-header-submenu-tabs > div.audit-header-submenu-tab > button.icon-audit-header)
3. Click on #boUtilsUserMenu (#boUtilsUserMenu)
