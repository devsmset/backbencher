...
**Generated from**: recording-1774357600232-final.json
**Date**: March 24, 2026
**Base URL**: https://maple-aio-2-m1.otxlab.net/bo
...
3. Click on Sign in (button.uxa-large.uxa-primary.cdk-focused.cdk-mouse-focused > span)
...
2. Click on 177091416 (div.fixedDataTableRowLayout_body > div.fixedDataTableCellGroupLayout_cellGroupWrapper > div.fixedDataTableCellGroupLayout_cellGroup > div.fixedDataTableCellLayout_main.public_fixedDataTableCell_main > div.entityGridCell > a)
3. Click on Users (form > div.entityDetailPageBody > div.entityDetailPageSidePanel > ul.entityDetailPageSideNavList > li > a.entityDetailPageSideNavLink)
4. Click on Licenses (form > div.entityDetailPageBody > div.entityDetailPageSidePanel > ul.entityDetailPageSideNavList > li > a.entityDetailPageSideNavLink)
...
### Test Steps
1. Click on Logout (li > a.dropdown-item)
